...
instance Autodocodec.HasCodec (Pointer' RFC6901Format LenientParsing) where
  codec = coerce $ Autodocodec.bimapCodec textOrPathToPointer (Left . formatPointer) Autodocodec.codec where

instance Autodocodec.HasCodec (Pointer' ArrayFormat LenientParsing) where
  codec = coerce $ Autodocodec.bimapCodec textOrPathToPointer pointerToPath Autodocodec.codec where
